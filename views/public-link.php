            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        ( _ => {
                            $('#<?= $_uid ?>1').on( 'click', e => {
                                $('input[name="public_link_expires"]').val( _.moment().add(1,'d').format('YYYY-MM-DD'));
                                $('input[name="public_link_expires"]').focus();

                            });

                            $('#<?= $_uid ?>7').on( 'click', e => {
                                $('input[name="public_link_expires"]').val( _.moment().add(7,'d').format('YYYY-MM-DD'));
                                $('input[name="public_link_expires"]').focus();

                            });

                            $('#<?= $_uid ?>30').on( 'click', e => {
                                $('input[name="public_link_expires"]').val( _.moment().add(30,'d').format('YYYY-MM-DD'));
                                $('input[name="public_link_expires"]').focus();
